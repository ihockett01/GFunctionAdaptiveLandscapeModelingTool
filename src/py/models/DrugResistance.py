...
class DrugResistance(s.BaseModel):
    ...
    ModelSchema = s.Schema(
        ...
        [
            s.SchemaObject('pop1'),
            s.SchemaObject('pop2'),
            s.SchemaObject('strat1'),
            s.SchemaObject('strat2'),
            s.SchemaObject('time', 1500),
            s.SchemaObject('km', 100),
            s.SchemaObject('r', [0.25,0.25]),
            s.SchemaObject('k', [0,0.2],'Evolvability: how fast cells can climb adaptive landscape'),
            s.SchemaObject('uopt', 0),
            s.SchemaObject('uopt2', 0, 'The cancer cell strategy for which the drug is maximally effective'),
            s.SchemaObject('s1', 0.2, 'Drug Dosage'),
            s.SchemaObject('f1', 1, 'Drug Efficacy'),
            s.SchemaObject('st', 2),
            s.SchemaObject('sk', 4, 'Squared value'),
            s.SchemaObject('sa', 100, 'Squared value'),
            s.SchemaObject('B', 2, 'NOT Squared value')   
        ])

    def __init_subclass__(self, parameters: dict[str, object]):
        pass
...
# # import Schema as bm
# from BaseModelsSchema import BaseModel as bm

# #Drug Resistance Model
# class Models:
#     class DrugResistance

#     class DrugResistenceOld():
